...
const Payment = () => {
  return (
    <section className='h-[100dvh] bg-[#F8F6F6] snap-start relative overflow-y-hidden'>
      ...
      />
      <img 
        src="/images/payments-pillar-large.png"
