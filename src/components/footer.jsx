  ...
  return (
    <footer className='absolute w-[100dvw] bottom-0 flex flex-row justify-between p-6 px-14 mdlap:px-10 smlap:hidden'>
      <div className='flex flex-row items-center gap-5'>
        ...
        <button className={`p-5 py-3 flex items-center justify-center gap-3 border-[1px] border-${antiThemeColor}-800 rounded-md bg-${themeColor}`}>
          <img 
            src="/images/playstore-green.png" 
            alt="PLay Store icon"
            className='w-5'
          />
          <div className={`text-${antiThemeColor} font-Agrandir text-[12px]`}>
      ...
      <div className='flex flex-row items-center gap-8'>
        ...
        <div className='flex flex-row items-center gap-8'>
          <button>
            <img 
              src={`/images/twitch-${antiThemeColor}.png`} 
              alt="Twitch icon"
              className='w-5'
            />
          </button>
          <button>
            <img 
              src={`/images/twitter-${antiThemeColor}.png`} 
              alt="Twitter icon"
            />
          </button>
          <button>
            <img 
              src={`/images/instagram-${antiThemeColor}.png`} 
              alt="Instagram icon"
              className='w-5'
            />
          </button>
